...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/button/button_elec.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.elec.setIcon(icon)
        self.elec.setIconSize(QSize(150, 150))
        self.nomal = QPushButton(self.preference1)
        self.nomal.setObjectName(u"nomal")
        self.nomal.setGeometry(QRect(390, 300, 151, 151))
        self.nomal.setStyleSheet(u"background-color:rgb(214, 226, 232);")
        icon1 = QIcon()
        icon1.addFile(u":/button/button_nomal.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.nomal.setIcon(icon1)
        self.nomal.setIconSize(QSize(150, 150))
        ...
        icon2 = QIcon()
        icon2.addFile(u":/button/button_handicap.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/button/button_small.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
